...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onAccessPointsFound(List<PHAccessPoint> accessPoint) {
            Log.w("Debug", "Access Points Found. " + accessPoint.size());
        ...
        public void onAuthenticationRequired(PHAccessPoint accessPoint) {
            Log.w("Debug", "Authentication Required.");
        ...
        public void onConnectionResumed(PHBridge bridge) {
            ...
            Log.v("Debug", "onConnectionResumed" + bridge.getResourceCache().getBridgeConfiguration().getIpAddress());
        ...
        public void onConnectionLost(PHAccessPoint accessPoint) {
            Log.v("Debug", "onConnectionLost : " + accessPoint.getIpAddress());
        ...
        public void onParsingErrors(List<PHHueParsingError> parsingErrorsList) {
            for (PHHueParsingError parsingError: parsingErrorsList) {
                Log.e("Debug", "ParsingError : " + parsingError.getMessage());
            }
        }
    };
